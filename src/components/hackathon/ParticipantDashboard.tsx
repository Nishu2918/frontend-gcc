    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white dashboard-container">
      ...
      >
          <AnimatePresence mode="wait">
                      ...
                      <div className="space-y-2">
                        {userRole === 'organizer' ? (
                          <>
                            ...
                            <Button3D
                              className="w-full justify-start bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-400 hover:to-pink-400 text-white font-semibold"
            ...
            {activeTab === 'ai-mentor' && (userRole === 'participant' || userRole === 'organizer') && (
