                    ...
                    <Card className="p-8 bg-gradient-to-br from-slate-800/90 to-slate-900/90 border-slate-700/50 backdrop-blur-sm glass shadow-3d">
                      ...
                      <div className="space-y-6">
                        <div>
                          ...
                          <p className="text-xs text-white/90 mt-1">Required: Provide your project's GitHub repository link</p>
                        </div>
                        ...
                        <Card3D intensity={15}>
                          <div>
                            ...
                            <p className="text-xs text-white/90 mb-2">Required: Upload your project code, documentation, and other files</p>
                            <motion.div 
                            ...
                            {uploadedFiles.length > 0 && (
                              <div className="mt-4 space-y-2">
                                <p className="text-sm text-white/90 mb-2 font-semibold">Project Files ({uploadedFiles.length}):</p>
                        ...
                        <Card3D intensity={15}>
                          <div>
                            ...
                            <p className="text-xs text-white/90 mb-2">Optional: Upload your project presentation slides</p>
                            <motion.div 
                            ...
                            {uploadedPresentations.length > 0 && (
                              <div className="mt-4 space-y-2">
                                <p className="text-sm text-white/90 mb-2 font-semibold">Presentation Files ({uploadedPresentations.length}):</p>
